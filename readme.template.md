...
[![Stars](https://img.shields.io/github/stars/Admonstrator/paperless-ai-patched?style=for-the-badge)](https://github.com/Admonstrator/paperless-ai-patched/stargazers)
...
- � Mistral OCR Queue – re-process poorly scanned documents via Mistral OCR API with real-time SSE progress
...
|                  | [UI-005](Included_Fixes/UI-005-mistral-ocr-queue/)             | Mistral OCR Queue for poorly scanned documents            | ✅ Applied |
